...
class MoneyExchange extends Component {
  ...
  updateRates = () => {
    ...
    axios.get('https://www.apilayer.net/api/live?access_key=' + access_key + '&currencies=' + currValues )
    .then(results => {
      console.log(results)
  ...
  getCurrencyValue = () => { 
    ...
    axios.get('https://www.apilayer.net/api/live?access_key=' + access_key + '&source=' + mainCurrency)
      .then(results => {
